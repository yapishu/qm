...
const USER_SCOPED: Rule[] = [
  ...
  pat("GET", "/v1/tlon/connections"),
  pat("POST", "/v1/tlon/connections"),
  pat("PUT", "/v1/tlon/connections/:id"),
  pat("DELETE", "/v1/tlon/connections/:id"),
...
const SYSTEM: Rule[] = [
  ...
  pat("POST", "/v1/tlon/installations/:id/status"),
  pat("POST", "/v1/tlon/installations/:id/lease"),
  pat("POST", "/v1/tlon/installations/:id/release"),
  pat("POST", "/v1/tlon/inbound"),
  pat("POST", "/v1/tlon/inbound/:id/ack"),
  pat("POST", "/v1/tlon/inbound/:id/release"),
